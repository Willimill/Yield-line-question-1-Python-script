...
# =============================================================================
user_result_x=[2,5,2.1,4,2,2,2,2.5,2.5,2.2,2]
user_result_y=[3.8,1.5,2,4,2,1.8,4.5,1.5,3,2.5,2]
staff_result_x=[2.1,2.5,2.5]
staff_result_y=[4.1,2.5,3.5]
eng_result_x=[2,2,2]
eng_result_y=[4,2,4]
# =============================================================================
...
for i in range(len(ratio_list_2d)):
    for x in range(len(ratio_list_2d[i])):
        if(ratio_list_2d[i][x]) > (min(corrected_list)+0.0000001):
            ratio_list_2d[i][x] = min(corrected_list)+5
Z = ratio_list_2d
Z_2 = valid_array_2d
...
plt.axis('scaled')
plt.show()
plt.savefig("Contour plot for step size: 0.1.png", dpi=300)